          ...
          <div className="fixed inset-0 bg-black/50 z-20 flex items-center justify-center px-5">
            <div className="bg-white rounded-2xl p-6 max-w-[340px] w-full space-y-4">
              ...
              <div className="space-y-2">
                <Button variant="primary" fullWidth onClick={handleUseResumeData}>
                  사용하기
                </Button>
                <Button variant="secondary" fullWidth onClick={handleManualInput}>
                  직접 입력
                </Button>
              </div>
            </div>
          ...
          {step === 1 && (
            <div className="space-y-6">
              ...
              <div className="flex bg-white rounded-xl border-2 border-gray-200 p-1">
                <button
                  onClick={() => setFormData({ ...formData, type: 'personality' })}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 rounded-xl p-4">
                ...
                <div className="space-y-1 text-sm">
                  <p><span className="text-gray-600">유형:</span> {formData.type === 'personality' ? '인성면접' : '기술면접'}</p>
                  <p><span className="text-gray-600">포지션:</span> {formData.position}</p>
                  <p><span className="text-gray-600">기업:</span> {formData.company || '미지정'}</p>
                </div>
              </div>
